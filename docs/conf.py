# -*- coding: utf-8 -*-
#
# pytest-docker documentation build configuration file, created by
...
project = u'pytest-docker'
copyright = u'2015, John Dennison'
author = u'John Dennison'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-docker Documentation',
     [author], 1)
]
